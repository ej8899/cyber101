...
---
Download the file(s) and try to find the hidden messages!

[hidden message in an image](emoji_image.png)  
  thanks, pavan_53295 (discord)  

[secret text message in a text file](secret.txt)  
  thanks, fredcyber (discord)

[click for SOLUTIONS](solutions.md)  
